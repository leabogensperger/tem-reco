...
(function() {
    ...
    var lteIE8 = Seadragon.Utils.getBrowser() == Seadragon.Browser.IE &&
        Seadragon.Utils.getBrowserVersion() < 9;
    ...
    Seadragon.MouseTracker = function(elmt) {
        ...
        function handleMouseClick(event) {
            ...
            var quick = time <= Seadragon.Config.clickTimeThreshold &&
                    distance <= Seadragon.Config.clickDistThreshold;
