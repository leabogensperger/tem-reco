...
(function() {
    ...
    function makeNavControl(viewer) {
        ...
        var zoomIn = new Seadragon.Button(Seadragon.Strings.getString("Tooltips.ZoomIn"),
        ...
        var zoomOut = new Seadragon.Button(Seadragon.Strings.getString("Tooltips.ZoomOut"),
        ...
        var goHome = new Seadragon.Button(Seadragon.Strings.getString("Tooltips.Home"),
                url(HOME, REST), url(HOME, GROUP), url(HOME, HOVER),
                url(HOME, DOWN), null, onHome, null, null, null);
        
        var fullPage = new Seadragon.Button(Seadragon.Strings.getString("Tooltips.FullPage"),
    ...
    Seadragon.Viewer = function(container) {
        ...
        this.openDzi = function(xmlUrlOrJsonObj, xmlString) {
            ...
            var callback = Seadragon.Utils.createCallback(null, onOpen, currentTime);
            
            switch (typeof(xmlUrlOrJsonObj)) {
            case "string":
                Seadragon.DziTileSource.createFromXml(xmlUrlOrJsonObj, xmlString, callback);
                break;
            default:
                Seadragon.DziTileSource.createFromJson(xmlUrlOrJsonObj, callback);
                break;
            }
        };
        ...
        this.setFullPage = function(fullPage) {
            ...
            if (viewport) {
                ...
                if (fullPage) {
                    ...
                    fsBoundsDelta = new Seadragon.Point(newBounds.width / oldBounds.width,
