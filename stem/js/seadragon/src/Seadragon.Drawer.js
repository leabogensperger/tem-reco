...
(function() {
    ...
    var hasIeFilters = (function() {
        try {
            return (browser == Seadragon.Browser.IE) &&
    ...
    var badCanvas =     // due to no subpixel precision
            ...
            ((browser == Seadragon.Browser.CHROME) && browserVer < 30);
		var useCanvas = hasCanvas && !badCanvas;
		
		// Fibics Force to use canvas (we are not in 2006 anymore!!!)
		//var useCanvas = true;
    var useCssTransforms = !useCanvas && hasCssTransforms;
		// Fibics Force to use CSS transforms (for the same reason!)
    ...
    //    browser == Seadragon.Browser.SAFARI && userAgent.match(/Mac OS X/) && (
    ...
    Tile.prototype.drawHTML = function(container) {
        ...
        if (useCssTransforms) {
            ...
            style[cssTransformProperty] = [
                'matrix(',
                (size.x / elmt.width).toFixed(8),
                ',0,0,',
                (size.y / elmt.height).toFixed(8),
                ',',
    ...
    function Overlay(elmt, loc, placement) {
        ...
        // Drawing
        this.adjust = createAdjustmentFunction(loc instanceof Seadragon.Point ?
                placement : Placement.TOP_LEFT);    // rects are always top-left
    ...
    Overlay.prototype.drawHTML = function(container) {
        ...
        if (Seadragon.Config.transformOverlays && hasCssTransforms) {
        ...
        } else if (Seadragon.Config.transformOverlays && useIeFilters) {
    ...
    Seadragon.Drawer = function(source, viewport, elmt) {
        ...
        var context = useCanvas ? canvas.getContext("2d") : null;
				...
				////////////////////////////////////////////////////////////////////////
				// hack from Fibics to make the canvas available outside of this file.
				////////////////////////////////////////////////////////////////////////
        ...
        function loadTile(tile, time) {
            tile.loading = imageLoader.loadImage(tile.url,
                    Seadragon.Utils.createCallback(null, onTileLoad, tile, time));
        }
...
//                    viewportTargetTL.x > 1 || viewportTargetTL.y > normHeight;
            ...
            var isChrome = (browser === Seadragon.Browser.CHROME);
            ...
            var minDimension = Seadragon.Config.minZoomDimension;   // for backwards compatibility
