...
def parse_arguments(args): 
    ...
    parser.add_argument('--gpu', type=int, default=0, help="The id of the GPU to be used.") # 0
    parser.add_argument('--base_dir', type=str, default='', help='Base directory for projection data.')
    ...
    parser.add_argument('--angle_file', type=str, default='') 
    
    parser.add_argument('--save_results', type=str2bool, default=True, help='Set to True if results should be saved.')
    parser.add_argument('--save_path', type=str, default='', help='Path to directory to save results.')
    ...
    parser.add_argument('--crop', type=int, default=512, help='Integer specifying how much to crop of proj data starting from centre.') 
...
if __name__ == '__main__':
    ...
    if args.save_results:
        np.save(save_path+'/proj_init.npy', proj_data)
    ...
    for i in range(max_iter):
        ...
        if dyn_plot and i % 5 == 0:
            ...
            ax[0,0].imshow(u[z//2,:,c-m//2:c+m//2].cpu(), cmap='gray'), ax[0,0].set_title('u mn')
            ax[0,1].imshow(u[:,m//2,c-m//2:c+m//2].cpu(), cmap='gray'), ax[0,1].set_title('u zn')
